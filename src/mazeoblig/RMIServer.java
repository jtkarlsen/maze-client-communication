...
public class RMIServer
{
  ...
  private static MazeServerImpl server;
  public static String MazeName = "Maze";
  public static String ServerName = "MazeServer";
  /**
  ...
  */
  ...
  public RMIServer() throws RemoteException, MalformedURLException,
    ...
    */
    ...
    /*
     * Legger inn spillerserveren
     */
    String urlStringServer = "//" + HOST_NAME + ":" + PORT + "/" +
    ServerName;
    server = new MazeServerImpl();
    Naming.rebind( urlStringServer, server );
    /**
